...
function getlanguagenameB(langcode:string):string;
begin
...
function getlanguagename(langcode:string):string;
begin
  Result:=getlanguagenameB(langcode);
  if (Result='') and (Length(langcode)>=5) then
    Result:=getlanguagenameB(LowerCase(Copy(langcode,1,2))+'_'+UpperCase(Copy(langcode,4,2)));
  if (Result='') and (Length(langcode)>=4) then
    Result:=getlanguagenameB(LowerCase(Copy(langcode,1,2))+'_'+UpperCase(Copy(langcode,3,2)));
  if (Result='') and (Length(langcode)>=2) then
    Result:=getlanguagenameB(LowerCase(Copy(langcode,1,2)));
end;
